...
i = 0
while i<50:
    avg_reward_kl_ucb = avg_reward_kl_ucb + kl_ucb(bandit_instance,i,np.int(len(bandit_instance)),100)
    i = i+1
avg_reward_kl_ucb = avg_reward_kl_ucb*(1.0/50.0)

file1 = open("kl2_plots.txt","a")
...
np.savetxt('kl_ucb_3_test.txt',avg_reward_kl_ucb)  
